    ...
    constructor(viewer, measurement, propertiesPanel) {
        ...
        this.elContent = $(`
			<div class="measurement_content selectable">
				...
				<br>
				<span style="font-weight: bold">${i18n.t("gismatrix.volume")}: </span>
				...
				<li>
					<label style="whitespace: nowrap">
						...
						<span>${i18n.t("gismatrix.makeClipVolume")}</span>
					</label>
				</li>
				...
				<li style="display: grid; grid-template-columns: auto auto; grid-column-gap: 5px; margin-top: 10px">
					<input id="volume_reset_orientation" type="button" value="${i18n.t("gismatrix.resetOrientation")}"/>
					<input id="volume_make_uniform" type="button" value="${i18n.t("gismatrix.makeUniform")}"/>
				</li>
