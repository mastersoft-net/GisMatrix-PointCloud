        ...
        this.elContent = $(`
			<div class="measurement_content selectable">
				...
				<span style="display:flex">
					<span style="display:flex; align-items: center; padding-right: 10px">${i18n.t("gismatrix.width")}: </span>
				...
				<input type="button" id="show_2d_profile" value="${i18n.t("gismatrix.show2dProfile")}" style="width: 100%"/>
